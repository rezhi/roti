            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                 <ul class="nav navbar-nav">
                    ...
                    <li ><a><b><i class="app-menu__icon fa fa-table"></i>&nbsp;&nbsp;DATA MASTER</b></a></li><!-- /.menu-title -->
                            <li ><i class="fa fa-circle">&nbsp;&nbsp;<a href="<?php echo base_url()?>Karyawan/read">Tabel Karyawan</a></i></li>
 ...
 <main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Tambah Data Roti</a></li>
        </ul>
      </div>
      <center>
<b><h2 >Data Roti</h2></b><hr>
<div style="color: red;"><?php echo (isset($model->data['message']))? $model->data['message'] : ""; ?></div>
 <table width="500px">
             <?php echo form_open("Roti/create", array('enctype'=>'multipart/form-data')); ?>
               <tr>
                    <td><?php echo $model->labels['nama_roti']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="nama_roti" size="30" maxlength="50" /></td>
                </tr>
                
                <tr>
                    <td><?php echo $model->labels['id_kategori']; ?></td>
                    <td>:</td>
                    <td><select name="id_kategori">
  <option value="1">Kue Basah</option>
  <option value="2">Roti Tawar</option>
  <option value="3">Kue Manis</option>
  <option value="4">Kue Gurih</option>
  <option value="5">Tart</option>
  <option value="6">Pastry</option>
</select></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['gambar']; ?></td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="harga" size="30" maxlength="10" /></td>
                </tr>
                   <tr>
                    <td></td>
                    <td></td>
                ...
                <td></td>
                    <td>
                <input  style="color: white;" type="submit" class="btn btn-primary" name="btnSubmit" value="SIMPAN"/>&nbsp;&nbsp;&nbsp;
                <input style="color: white;" type="button" class="btn btn-danger" name="Batal" value="BATAL" onclick="javascript:history.go(-1);"/></td></tr>
</b>
<?php echo form_close(); ?>
</table></center>
    </main>
