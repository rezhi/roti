...
<b><h2 >Data Kategori</h2></b><hr>
            ...
            <form action="create" method="POST">
                <tr>
                    <td><b><?php echo $model->labels['id_roti']; ?></b></td>
                    <td>:</td>
                    <td><b><input readonly type="text" name="id_roti" size="30" maxlength="30" value="<?php echo $model->id_roti; ?>" /></b></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['harga']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="harga" size="30" maxlength="30" value="<?php echo $model->harga; ?>" /></td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
