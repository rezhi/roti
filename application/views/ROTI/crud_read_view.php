...
<p><b><a href="<?php echo base_url()?>Roti/create" class="btn btn-success"><span class="fa fa-user fa-lg"></span> Tambah</a></b></p> 
    <a href="<?php echo base_url()?>Roti/index/1" class="btn btn-warning btn-sm" style="color: white">Kue Manis</a>
    <a href="<?php echo base_url()?>Roti/index/2" class="btn btn-warning btn-sm" style="color: white">Kue Gurih</a>
    <a href="<?php echo base_url()?>Roti/index/3" class="btn btn-warning btn-sm" style="color: white">Tart</a>
    <a href="<?php echo base_url()?>Roti/index/4" class="btn btn-warning btn-sm" style="color: white">Kue Basah</a><br><br>
