...
<b><h2 >Data Karyawan</h2></b><hr>
            ...
            <form action="update" method="POST">
                <tr>
                    <td><b><?php echo $model->labels['id_transaksi']; ?></b></td>
                    <td>:</td>
                    <td><b><input readonly type="text" name="id_transaksi" size="30" maxlength="30" value="<?php echo $model->id_transaksi; ?>" /></b></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['dp']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="dp" size="30" maxlength="30" value="<?php echo $model->dp; ?>" /></td>
                </tr>
