...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a href="<?php echo base_url()?>Pesanan/home/<?php echo $row->id_transaksi?>" style="color: green" ><span class="fa fa-shopping-bag fa-lg" ></span></a></td>
