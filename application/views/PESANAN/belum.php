...
<table  id="bootstrap-data-table" class="table table-striped table-bordered" style="font-size:14px;margin-top:10px;">
    <tr>
        <th >ID</th>
        <th >Nama </th>
         <th >No. HP </th>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a style="color: green" href="<?php echo base_url()?>Pesanan/homebelum/<?php echo $row->id_transaksi?>"> <span class="fa fa-shopping-bag fa-lg" ></span></a></td>

        <td><a style="color: blue" href="<?php echo base_url()?>Pesanan/update/<?php echo $row->id_transaksi?>" ><span class="fa fa-edit fa-lg" ></span></a></td>
        <td><a style="color: red" href="<?php echo base_url()?>Pesanan/delete/<?php echo $row->id_transaksi;  ?>"><span class="fa fa-trash fa-lg" ></span></a></td>
    </tr>
    <?php
}
?>
